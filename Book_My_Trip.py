...
def book_trip(uemail,password):                                                 # Booking of Trip and genrating bill and saving history
    ...
    E_Name.configure(disabledforeground="#6f6f64",disabledbackground="#cbd9ca",relief='flat',foreground="#000000",insertbackground="#6f6f64",font=('Helvetica', 32,'bold'))
...
def Add_New_driver():                                            
    ...
    Text2.configure(background="white",font=('Consolas',16,'bold'),foreground="black",highlightbackground="#d9d9d9",highlightcolor="black",insertbackground="black",selectbackground="blue",selectforeground="white",wrap="word")
